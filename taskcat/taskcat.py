...
class TaskCat (object):
    ...
    def genreport(self, stackdata):
        ...
        output_css = 'taskcat/output-assets/taskcat.css'
        ...
        with tag('html'):
            ...
            with tag('body'):
                tested_on = time.strftime('%A - %b,%d,%Y')
                            ...
                            with tag('tr'):
                                ...
                                with tag('td', 'class=text-left'):
                                    with tag('a', href=getlogfile()):
                                        text('View Logs')
                        with tag('td', 'colspan=4', 'class=text-right'):
                            tested_on = time.strftime('%H:%M:%S')
                            text('Time of test: ', tested_on)
                    doc.stag('p')
